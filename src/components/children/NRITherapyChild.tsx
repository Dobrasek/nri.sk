...
const playlist = [
  ...
  { n: '04', song: 'Imagine Dragons — Demons', bpm: '84 BPM', goal: 'Emócie & Limbický', desc: 'Striedanie hojdania a aktívnejšieho pohybu. V pomalých častiach sa dieťa s dospelým pokojne hojdá zo strany na stranu. V dynamickejších častiach prechádza do pohybu rúk cez os tela — naznačeného boxovania.', color: '#7a2d45' },
